...
namespace StateMachine.AsyncEx {
	...
	/// </summary>
	[DebuggerDisplay("Id = {Id}, AsyncLockId = {_asyncLock.Id}"), DebuggerTypeProxy(typeof(DebugView))]
	public sealed class AsyncConditionVariable {
		...
		/// <summary>
		///     Sends a signal to a single task waiting on this condition variable. The associated lock MUST be held when calling
		///     this method, and it will still be held when this method returns.
		/// </summary>
		public void Notify() {
			lock (_mutex) {
		...
		/// <summary>
		///     Sends a signal to all tasks waiting on this condition variable. The associated lock MUST be held when calling this
		///     method, and it will still be held when this method returns.
		/// </summary>
		public void NotifyAll() {
			lock (_mutex) _queue.DequeueAll();
		}

		/// <summary>
		///     Asynchronously waits for a signal on this condition variable. The associated lock MUST be held when calling this
		///     method, and it will still be held when this method returns, even if the method is cancelled.
		/// </summary>
		...
		/// <summary>
		///     Asynchronously waits for a signal on this condition variable. The associated lock MUST be held when calling this
		///     method, and it will still be held when the returned task completes.
		/// </summary>
		public Task WaitAsync() => WaitAsync(CancellationToken.None);

		/// <summary>
		///     Synchronously waits for a signal on this condition variable. This method may block the calling thread. The
		///     associated lock MUST be held when calling this method, and it will still be held when this method returns, even if
		///     the method is cancelled.
		/// </summary>
		/// <param name="cancellationToken">The cancellation signal used to cancel this wait.</param>
		...
		/// <summary>
		///     Synchronously waits for a signal on this condition variable. This method may block the calling thread. The
		///     associated lock MUST be held when calling this method, and it will still be held when this method returns.
		/// </summary>
		public void Wait() {
