namespace StateMachine.AsyncEx {
	...
	public static class SynchronousTaskExtensions {
		...
		///     The <paramref name="cancellationToken" /> was cancelled before the
		///     <paramref name="task" /> completed, or the <paramref name="task" /> raised an
